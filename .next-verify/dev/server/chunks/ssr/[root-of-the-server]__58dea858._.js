...
"[project]/lib/client/prefetch.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function schedulePrefetch(task) {
    if (("TURBOPACK compile-time value", "undefined") === "undefined" || completedTasks.has(task.key) || inflightTasks.has(task.key)) {
        return;
    }
...
"[project]/components/ui/smart-link.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SmartLink({ children, href, onFocus, onMouseEnter, prefetchMode = "idle", warmTasks = [], ...props }) {
    ...
    const triggerPrefetch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((priority)=>{
        if (hrefValue) {
...
function PostHogProvider({ children }) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$posthog$2d$js$2f$dist$2f$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].init(posthogKey, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__58dea858._.js.map